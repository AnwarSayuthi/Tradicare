<div class="tab-content" id="appointmentTabsContent">
    ...
    <div class="tab-pane fade show active" id="scheduled" role="tabpanel" aria-labelledby="scheduled-tab">
        @php
            $scheduledAppointments = isset($appointments) ? $appointments->where('status', 'scheduled') : collect();
        @endphp
    ...
    <div class="tab-pane fade" id="cancelled-appointments" role="tabpanel" aria-labelledby="cancelled-appointments-tab">
        @php
            $cancelledAppointments = isset($appointments) ? $appointments->where('status', 'cancelled') : collect();
        @endphp
